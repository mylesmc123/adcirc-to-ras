...
class HecWindFile:
    ...
    def write(
        ...
        ds.source = "adcirc2hecwind.py"
        ds.history = "Created {:s}".format(datetime.utcnow().strftime("%Y-%m-%d %H:%M"))
        ds.metadata_conventions = "Data generated by adcirc2hecwind.py for HEC-RAS"
...
def adcirc2hecwind_main():
    """
    Main function for the adcirc2hecwind.py script
    ...
    r.write(args.resolution, x_min, y_min, x_max, y_max, args.reference_time)
